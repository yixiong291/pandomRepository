                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <div class="page-header">
                            ...
                            <span style="color: green;font-family: 'Book Antiqua'">${msg}</span>
                        </div>
                    </div>
                </div>
            </div>
                <div class="container">
                    <div class="col-md-12 column">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                            <span style="font-family: 'Book Antiqua';color: red ; font-weight: bolder">${mes}</span>
                            <c:forEach var="book1" items="${book}">
                                <tr>
                                    ...
                                    <td>${book1.ISBN}</td>
                                    <td><a href="${pageContext.request.contextPath}/borrow/returnBook?bookName=${book1.bookName}&name=${sessionScope.username}"><button type="button" class="btn btn-info btn-default btn-sm"><span>图书还书</span></button></a> <span style="color: green;font-family: 'Book Antiqua'">${succeed}</span></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
