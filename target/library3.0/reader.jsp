    ...
    <div class="container">
        <div class="row clearfix">
            ...
            <div class="container">
                <div class="col-md-12 column">
                    <div class="page-header">
                        <h2><small>当前用户--${sessionScope.username}</small></h2>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="col-md-8 column">
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/reader/update">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">用户名</label>
                            <div class="col-sm-10">
                                <input type="email" name="reName" class="form-control" id="inputEmail3" placeholder="" value="${reader.reName}" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="id" class="col-sm-2 control-label">学生id</label>
                            <div class="col-sm-10">
                                <input type="text" name="stuID" class="form-control" id="id" placeholder="" value="${reader.stuID}" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sex" class="col-sm-2 control-label">性别</label>
                            <div class="col-sm-10">
                                <input type="text" name="reSex" class="form-control" id="sex" placeholder="" value="${reader.reSex}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Email" class="col-sm-2 control-label">联系方式</label>
                            <div class="col-sm-10">
                                <input name="Email" type="text" class="form-control" id="Email" placeholder="" value="${reader.email}">
                            </div>
                        </div>
                        <div class="form-group">
